  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'instrumenters/flummox_instrumenter.cc',
        'instrumenters/flummox_instrumenter.h',
        'instrumenters/instrumenter_with_agent.cc',
        'instrumenters/instrumenter_with_agent.h',
        'instrumenters/instrumenter_with_relinker.cc',
        'instrumenters/instrumenter_with_relinker.h',
        ...
        'transforms/allocation_filter_transform.cc',
        'transforms/allocation_filter_transform.h',
        ...
        'transforms/afl_transform.h',
        'transforms/afl_transform.cc',
        'transforms/security_cookie_check_hook_transform.h',
        'transforms/security_cookie_check_hook_transform.cc',
        'transforms/add_implicit_tls_transform.h',
        'transforms/add_implicit_tls_transform.cc',
      ],
      'dependencies': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'instrumenters/flummox_instrumenter_unittest.cc',
        'instrumenters/instrumenter_with_agent_unittest.cc',
        'instrumenters/instrumenter_with_relinker_unittest.cc',
        ...
        'transforms/allocation_filter_transform_unittest.cc',
        ...
        'transforms/afl_transform_unittest.cc',
        'transforms/security_cookie_check_hook_transform_unittest.cc',
        'transforms/add_implicit_tls_transform_unittest.cc',
